              ...
              <div className="col-lg-12 mx-auto my-5">
                <div className="left-footer">
                  <img
                    ...
                    className="mb-2"
                  />
                  <p style={{ fontSize: '.9rem' }}>Contact Us</p>
                  <p style={{ fontSize: '.9rem' }}>wealthautomatically.com</p>
                  <p style={{ fontSize: '.9rem' }}> +1 407-900-1195</p>
                  <p style={{ fontSize: '.9rem' }}>801 Brickell Ave, Suite 900 ,</p>
                  <p style={{ fontSize: '.9rem' }}>Miami , Florida , United States ,33131</p>
